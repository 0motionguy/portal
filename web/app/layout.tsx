...
const JSON_LD = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      headline:
        "Portal v0.1.11 — agent commerce: PE-002 paid tools, x402-adapter, Cloudflare Worker reference with paid endpoint",
      description:
        "Two endpoints, one manifest. 30-second conformance check via runSmokeConformance. Ship a Portal in 10 minutes — on Node, Hono, FastAPI, Cloudflare Workers, or a static host.",
      url: `${SITE_URL}/docs`,
      inLanguage: "en-US",
      author: {
        "@type": "Person",
