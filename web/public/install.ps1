...
# Helper: scripts/compute-install-sha.sh v0.1.8 prints both values to paste here.
...
$RepoRef           = 'v0.1.8'
$RepoTarballSha256 = '9f0a9f4d626bfbc12ddc6b4ebfd56f19a2cfc6201516ffbfb40264c45ea468a7'
