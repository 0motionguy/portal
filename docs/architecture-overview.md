...
Normative spec: [`docs/spec-v0.1.8.md §4`](./spec-v0.1.8.md). Machine-readable: [`packages/spec/manifest.schema.json`](../packages/spec/manifest.schema.json).
...
Discovery: `GET /portal` is canonical; `GET /.well-known/portal.json` is an alternate path that MUST be byte-identical when both are served (spec Appendix E, draft in v0.1.8, normative in v0.2). See [`reference/trending-demo/src/server.ts:46-51`](../reference/trending-demo/src/server.ts#L46-L51).

---

## 3. Portal Call API Spec

Normative: [`docs/spec-v0.1.8.md §3.2 + §6`](./spec-v0.1.8.md). Provider helper: [`packages/provider/ts/src/serve.ts`](../packages/provider/ts/src/serve.ts).
...
- `"erc8004"` — verified-agent identity. Documented as Portal Extension PE-001; see [`docs/spec-v0.1.8.md §8`](./spec-v0.1.8.md).
