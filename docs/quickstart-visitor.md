...
`CallFailed.code` is one of: `NOT_FOUND`, `INVALID_PARAMS`, `UNAUTHORIZED`, `RATE_LIMITED`, `INTERNAL` ([spec §6](./spec-v0.1.8.md#6-error-codes-normative)).
...
- [Spec v0.1.8](./spec-v0.1.8.md) — two endpoints, one manifest, six pages total.
