...
`CallFailed.code` is one of: `NOT_FOUND`, `INVALID_PARAMS`, `UNAUTHORIZED`, `RATE_LIMITED`, `INTERNAL` ([spec §6](./spec-v0.1.5.md#6-error-codes-normative)).
...
- [Spec v0.1.5](./spec-v0.1.5.md) — two endpoints, one manifest, six pages total.
