...
Tracks monorepo release **v0.1.8**. Normative spec document: [`docs/spec-v0.1.8.md`](../../docs/spec-v0.1.8.md).
...
If `manifestOk && notFoundOk`, your service passes the v0.1.8 smoke test.
...
Runs the canonical test vectors offline. Zero network. Adopter-facing
CI pre-flight.
...
Frozen normative document: [`docs/spec-v0.1.8.md`](../../docs/spec-v0.1.8.md).
